  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        <h3>
          <a
            ...
            target="_blank"
          >
            {t("LLM prompting best practices")}
          </a>
        </h3>
      ...
      <div className="mt-4 py-2 px-3 rounded-md w-3/4">
        <p className="">
          {t("Presentation for Jõhvi Gümnaasium on the context and best practices of LLMs. Utilized")}{" "}
          <a href="https://revealjs.com/" target="_blank">
            reveal.js
          </a>{" "}
          {t("for creating the presentation. A powerful presentation tool for developers.")}
        </p>
